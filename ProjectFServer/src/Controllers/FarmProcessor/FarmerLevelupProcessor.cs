...
//             if(userData.farmerData.farmerDatas.ContainsKey(request.farmerUUID) == false)
//                 return ErrorPacket(ENetworkResult.DataNotFound);

//             var levelupGoldTable = DataTableManager.GetTable<FarmerLevelupGoldTable>();
//             var farmerRarity = userData.farmerData.farmerDatas[request.farmerUUID].rarity;
//             var level = userData.farmerData.farmerDatas[request.farmerUUID].level;
...
//                 userData.farmerData.farmerDatas[request.farmerUUID].level = level + 1;
//             }
