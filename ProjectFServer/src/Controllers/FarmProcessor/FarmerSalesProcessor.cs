...
//             {
//                 if(userData.farmerData.farmerDatas.ContainsKey(uuid) == false)
//                 return ErrorPacket(ENetworkResult.DataNotFound);
//             }

//             var farmerList = userData.farmerData.farmerDatas;
...
//                     userData.farmerData.farmerDatas.Remove(data.farmerUUID);
//                 }
//             }
